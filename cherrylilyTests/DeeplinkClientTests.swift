...
struct DeeplinkClientTests {
  ...
  @Test func emptyURLReturnsOpen() {
    let url = URL(string: "cherrylily://")!
    #expect(parse(url) == .open)
  }

  @Test func helpURLReturnsHelp() {
    let url = URL(string: "cherrylily://help")!
  ...
  @Test func worktreeTabWithValidUUID() {
    ...
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/550E8400-E29B-41D4-A716-446655440000")!
    #expect(parse(url) == .worktree(id: "/tmp/repo/wt-1", action: .tab(tabID: tabUUID)))
  }

  @Test func worktreeTabWithInvalidUUIDReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/not-a-uuid")!
    #expect(parse(url) == nil)
  }

  @Test func worktreeTabWithoutTabIDReturnsNil() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab")!
    #expect(parse(url) == nil)
  }

  @Test func worktreeTabNewWithoutInput() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/new")!
    #expect(parse(url) == .worktree(id: "/tmp/repo/wt-1", action: .tabNew(input: nil, id: nil)))
  }

  @Test func worktreeTabNewWithInput() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/new?input=echo%20hello")!
  ...
  @Test func worktreeTabDestroy() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)/destroy")!
  ...
  @Test func worktreeSurfaceFocus() {
    ...
    let url = URL(
      string: "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)"
    )!
    #expect(
      parse(url)
  ...
  @Test func worktreeSurfaceFocusWithInput() {
    ...
    let surfaceUUID = UUID(uuidString: "660E8400-E29B-41D4-A716-446655440000")!
    let url = URL(
      string: "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)?input=ls"
    )!
    #expect(
      parse(url)
  ...
  @Test func worktreeSurfaceSplitHorizontal() {
    ...
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let surfaceUUID = UUID(uuidString: "660E8400-E29B-41D4-A716-446655440000")!
    let base = "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)"
  ...
  @Test func worktreeSurfaceSplitDefaultsToHorizontal() {
    ...
    let url = URL(
      string:
        "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/\(surfaceUUID.uuidString)/split"
    )!
    #expect(
      parse(url)
        == .worktree(
  ...
  @Test func worktreeSurfaceInvalidUUIDReturnsNil() {
    ...
    let tabUUID = UUID(uuidString: "550E8400-E29B-41D4-A716-446655440000")!
    let url = URL(
      string: "cherrylily://worktree/\(encoded)/tab/\(tabUUID.uuidString)/surface/not-a-uuid"
    )!
    #expect(parse(url) == nil)
  }
  ...
  @Test func repoWorktreeNewWithBranch() {
    ...
    let url = URL(
      string: "cherrylily://repo/\(repoEncoded)/worktree/new?branch=feature-x&base=main&fetch=true"
    )!
    #expect(
      parse(url)
        == .repoWorktreeNew(
  ...
  @Test func repoWorktreeNewWithoutBranch() {
    let repoEncoded = "%2Ftmp%2Frepo"
    let url = URL(string: "cherrylily://repo/\(repoEncoded)/worktree/new")!
    #expect(
      parse(url)
        == .repoWorktreeNew(
          repositoryID: "/tmp/repo",
  ...
  @Test func repoUnknownPathReturnsNil() {
    let repoEncoded = "%2Ftmp%2Frepo"
    let url = URL(string: "cherrylily://repo/\(repoEncoded)/unknown")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeTabNewWithID() {
    ...
    let url = URL(string: "cherrylily://worktree/\(encoded)/tab/new?id=\(tabID.uuidString)")!
  ...
  @Test func repoOpenWithEmptyPathReturnsNil() {
    let url = URL(string: "cherrylily://repo/open?path=")!
    #expect(parse(url) == nil)
  }

  @Test func repoOpenWithRelativePathReturnsNil() {
    let url = URL(string: "cherrylily://repo/open?path=relative/path")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func worktreeStop() {
    let encoded = "%2Ftmp%2Frepo%2Fwt-1"
    let url = URL(string: "cherrylily://worktree/\(encoded)/stop")!
  ...
  @Test func worktreeWithNoIDReturnsNil() {
    let url = URL(string: "cherrylily://worktree")!
    #expect(parse(url) == nil)
  }
  ...
  @Test func unknownHostReturnsNil() {
    let url = URL(string: "cherrylily://unknown/something")!
    #expect(parse(url) == nil)
  }
}
