...
struct DeveloperSettingsView: View {
  ...
  var body: some View {
    Form {
      Section(
        footer: Text("CLI, hooks, and skills are optional and extend CherryLily without affecting core functionality.")
      ) {}
      Section {
        DeeplinkRow()
        CLIInstallRow(store: store)
      } footer: {
        Text("Symlinks `cherrylily` to `/usr/local/bin`. This is not required to run `cherrylily` in the app terminals.")
      }
      Section {
        AgentInstallRow(
        ...
        AgentInstallRow(
          ...
          subtitle: "Forward richer notifications to CherryLily."
        )
        AgentInstallRow(
          ...
          title: "CLI Skill",
          subtitle: "Teach Claude Code how to use the CherryLily CLI."
        )
      } header: {
        Label {
          Text("Claude Code")
      ...
      Section {
        ...
        AgentInstallRow(
          ...
          title: "CLI Skill",
          subtitle: "Teach Codex how to use the CherryLily CLI."
        )
      } header: {
        Label {
          Text("Codex")
