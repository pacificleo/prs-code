...
nonisolated enum SettingsFileURLKey: DependencyKey {
  static var liveValue: URL { CherryLilyPaths.settingsURL }
  static var previewValue: URL { CherryLilyPaths.settingsURL }
  static var testValue: URL { CherryLilyPaths.settingsURL }
}
