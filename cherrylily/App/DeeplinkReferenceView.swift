...
struct DeeplinkReferenceView: View {
  var body: some View {
    Form {
      Section {
        ...
        Text("Use the \(code("cherrylily://")) URL scheme to control CherryLily from the terminal, scripts, or other apps.")
      }
  ...
  private static let generalRows: [DeeplinkEntry] = [
    .init(url: "cherrylily://", description: "Bring app to front."),
    .init(url: "cherrylily://help", description: "Open this reference."),
  ]

  private static let worktreeRows: [DeeplinkEntry] = [
    .init(url: "cherrylily://worktree/<worktree_id>", description: "Select worktree."),
    .init(url: "cherrylily://worktree/<worktree_id>/run", description: "Run the worktree script."),
    .init(url: "cherrylily://worktree/<worktree_id>/stop", description: "Stop the running script."),
    .init(url: "cherrylily://worktree/<worktree_id>/archive", description: "Archive the worktree."),
    .init(url: "cherrylily://worktree/<worktree_id>/unarchive", description: "Unarchive the worktree."),
    .init(url: "cherrylily://worktree/<worktree_id>/delete", description: "Delete the worktree."),
    .init(url: "cherrylily://worktree/<worktree_id>/pin", description: "Pin the worktree."),
    .init(url: "cherrylily://worktree/<worktree_id>/unpin", description: "Unpin the worktree."),
  ]

  private static let tabSurfaceRows: [DeeplinkEntry] = [
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/<tab_id>",
      description: "Focus a tab."
    ),
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/new",
      description: "Create a new tab.",
      params: "?input=<cmd>&id=<uuid>"
    ),
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/<tab_id>/destroy",
      description: "Close a tab."
    ),
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/<tab_id>/surface/<surface_id>",
      description: "Focus a surface.",
      params: "?input=<cmd>"
    ),
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/<tab_id>/surface/<surface_id>/split",
      description: "Split a surface. Defaults to horizontal.",
      params: "?direction=horizontal|vertical&input=<cmd>&id=<uuid>"
    ),
    .init(
      url: "cherrylily://worktree/<worktree_id>/tab/<tab_id>/surface/<surface_id>/destroy",
      description: "Close a surface."
    ),
  ]

  private static let repoRows: [DeeplinkEntry] = [
    .init(url: "cherrylily://repo/open?path=<absolute-path>", description: "Open a repository."),
    .init(
      url: "cherrylily://repo/<repo_id>/worktree/new",
  ...
  private static let settingsRows: [DeeplinkEntry] = [
    .init(url: "cherrylily://settings", description: "Open settings."),
    .init(
      url: "cherrylily://settings/<section>",
      description: "Open a specific section.",
      params: "general|notifications|worktrees|developer|shortcuts|updates|github"
    ),
    .init(url: "cherrylily://settings/repo/<repo_id>", description: "Open repository settings."),
  ]
}
